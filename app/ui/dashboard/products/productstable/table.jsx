      ...
      <table className=" w-full mt-5 ms-3 p-5 ">
        ...
        <tbody>
          <tr>
            ...
            <td className="my-0.5 w-fit">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi, sit?</td>
          ...
          <tr>
            ...
            <td className="my-0.5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi, sit?</td>
            <td className="my-0.5">15</td>
            <td className="my-0.5">Oct 20 2021</td>
            <td className="my-0.5">$123</td>
            <td className="my-0.5  gap-1">
